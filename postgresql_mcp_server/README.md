...
- **Multi-Database Compatibility**: Support for PostgreSQL,RaseSQL
- **Asynchronous Architecture**: Built with `asyncpg` for high-performance database operations
...
- Python >= 3.12
- PostgreSQL,RaseSQL database instance
...
```bash
{
    ...
    "dbMaxOverflow": 10,
    "dbPoolTimeout": 30,
    "dbType-Comment": "The database currently in use,such as PostgreSQL,RaseSQL DataBases",
    "dbList": [
        {   "dbInstanceId": "postgresql_1",
            "dbHost": "localhost",
            "dbPort": 5432,
            "dbDatabase": "pg_db",
            "dbUsername": "root",
